...
# The line below adds a time series of 8 years to estimate population size
time_yr <- seq(from = 0, to = 8, by = 1)

# The line below creates a new empty matrix of our initial population structure by our new time variable
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below populates the first row with year 0 population sizes
